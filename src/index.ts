...
export class ExpoMixpanelAnalytics {
  ...
  queue: any[];
  superProps: any = {};
  mustSkipEventFields: [string?] = []
  mustSkipProfileFields: [string?] = []

  constructor(token, mustSkipEventFields: [string?] = [], mustSkipProfileFields: [string?] = []) {
    this.ready = false;
    this.queue = [];
    this.mustSkipEventFields = mustSkipEventFields;
    this.mustSkipProfileFields = mustSkipProfileFields;
